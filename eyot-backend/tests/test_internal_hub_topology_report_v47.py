...
from app.main import eyot_error_handler, validation_exception_handler
...
_TEST_TOKEN = "test-eyot-internal-token"
...
def internal_client(db_url: str, monkeypatch: pytest.MonkeyPatch) -> TestClient:
    ...
    app = FastAPI()
    app.add_exception_handler(EyotError, eyot_error_handler)
